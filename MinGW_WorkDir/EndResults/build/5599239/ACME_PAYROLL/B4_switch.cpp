...
void VCAST_USER_CODE_UNIT_11( VCAST_USER_CODE_TYPE, int );
void VCAST_USER_CODE_UNIT_12( VCAST_USER_CODE_TYPE, int );
void vcast_B4_switch( int VCAST_UNIT_INDEX, VCAST_USER_CODE_TYPE uct, int vcast_slot_index ) {
  switch( VCAST_UNIT_INDEX ) {
    case 0:
      ...
      VCAST_USER_CODE_UNIT_11( uct, vcast_slot_index );
      VCAST_USER_CODE_UNIT_12( uct, vcast_slot_index );
#if defined(VCAST_CPP_ENVIRONMENT)
