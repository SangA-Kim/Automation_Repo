...
/*vcast_header_expansion_start:Acme_PayrollSystem_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
extern int vCAST_ITERATION_COUNTERS [5][12];
/***********************************************
 *      VectorCAST Test Harness Component      *
 *     Copyright 2021 Vector Informatik, GmbH.    *
 *              20.sp6 (02/02/21)              *
...
void VCAST_DRIVER_12( int VC_SUBPROGRAM );
/*vcast_header_expansion_end*/
...
void vCAST_COMMON_STUB_PROC_11(
            ...
            int robjectIndex,
            int readEobjectData );
void vCAST_VALUE_USER_CODE_12(int vcast_slot_index );
void vCAST_EXPECTED_USER_CODE_12(int vcast_slot_index );
void vCAST_EGLOBALS_USER_CODE_12(int vcast_slot_index );
void vCAST_STUB_PROCESSING_12(
        int UnitIndex,
        int SubprogramIndex );
void vCAST_BEGIN_STUB_PROC_12(
        int UnitIndex,
        int SubprogramIndex );
  ...
  try {
    ...
    switch( VC_SUBPROGRAM ) {
      ...
      case 2: {
        ...
        if ((P_9_2_1 == (0) )) vCAST_APPEND_HISTORY_FLAG('P');
                  ...
                  case 1: {
                    if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                      ...
                      if (vcast_item1 == 0) {
                        ...
                        memset(vcast_item1->vcast_item, 0x0, sizeof ((*((double *)(vcast_item1->vcast_item)))));
                ...
                case 2: {
                  if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                    ...
                    if (vcast_item2 == 0) {
                      ...
                      memset(vcast_item2->vcast_item, 0x0, sizeof ((*((double *)(vcast_item2->vcast_item)))));
...
void VCAST_TI_9_7 ( double *vcast_param )
{
  ...
  case vCAST_FIRST_VAL :
    *vcast_param = -(double(1.79769313486231570815e+308L));
    break;
  case vCAST_MID_VAL :
    *vcast_param = 0;
    break;
...
void VCAST_TI_RANGE_DATA_9 ( void ) {
  ...
  vectorcast_fprint_long_float (vCAST_OUTPUT_FILE,-(double(1.79769313486231570815e+308L)) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:Acme_PayrollSystem_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
