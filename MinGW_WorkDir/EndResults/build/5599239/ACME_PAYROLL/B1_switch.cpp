...
void VCAST_RUN_DATA_IF_11( int, int );
void VCAST_RUN_DATA_IF_12( int, int );
...
case 1: /* TI RANGE DATA */
  ...
  VCAST_TI_RANGE_DATA_11();
  VCAST_TI_RANGE_DATA_12();
  break;
case 8:
...
case 9:
  ...
  break;
case 11:
  VCAST_RUN_DATA_IF_11(VCAST_SUB_INDEX, VCAST_PARAM_INDEX);
  break;
case 12:
  VCAST_RUN_DATA_IF_12(VCAST_SUB_INDEX, VCAST_PARAM_INDEX);
  break;
case 10: /* PROTOTYPES */
  switch( VCAST_SUB_INDEX ) {
    case 0: /* Defined externs */
      ...
      break;
        case 1:
          /* For vcast_concrete_PayrollSystem::processPayCheck */
          VCAST_RUN_DATA_IF_9( 7, VCAST_PARAM_INDEX );
          break;
        case 2:
          /* For vcast_concrete_PayrollSystem::vcast_concrete_PayrollSystem */
          VCAST_RUN_DATA_IF_9( 8, VCAST_PARAM_INDEX );
          break;
        case 3:
          /* For PayrollSystem::processPayCheck */
