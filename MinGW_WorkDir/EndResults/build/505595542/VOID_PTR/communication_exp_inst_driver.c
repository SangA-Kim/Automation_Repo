...
/*vcast_header_expansion_start:communication_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
---------------------------------------------
*/
extern vCAST_array_boolean vCAST_GLOBALS_TOUCHED[8];
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:communication_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
