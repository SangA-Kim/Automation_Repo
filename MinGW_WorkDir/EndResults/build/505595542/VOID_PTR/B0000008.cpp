 ...
 *
 * Path: C:/VCAST/Environments/Git_Test/MinGW_WorkDir/EndResults/build/505595542/VOID_PTR/S0000008.cpp
 *
 * Type: not-stubbed
 *
 * Unit Number: 8
  ...
  switch ( VCAST_SUB_INDEX ) {
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        case 1: /* for global object AltCmd */
          VCAST_TI_8_4 ( &(AltCmd));
          break;
        case 2: /* for global object CourseCmd */
          VCAST_TI_8_6 ( &(CourseCmd));
          break;
        case 3: /* for global object VECTORCAST_INT1 */
          VCAST_TI_8_1 ( &(VECTORCAST_INT1));
          break;
        case 4: /* for global object VECTORCAST_INT2 */
          VCAST_TI_8_1 ( &(VECTORCAST_INT2));
          break;
        case 5: /* for global object VECTORCAST_INT3 */
          VCAST_TI_8_1 ( &(VECTORCAST_INT3));
          break;
        case 6: /* for global object VECTORCAST_FLT1 */
          VCAST_TI_8_8 ( &(VECTORCAST_FLT1));
          break;
        case 7: /* for global object VECTORCAST_STR1 */
          VCAST_TI_8_9 ( VECTORCAST_STR1);
          break;
        case 8: /* for global object VECTORCAST_BUFFER */
          VCAST_TI_8_10 ( VECTORCAST_BUFFER);
          break;
        default:
...
struct VCAST_CSU_Data *vcast_csu_data_8 = (struct VCAST_CSU_Data *)0;

/* A struct */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_4 ( struct AltCmd *vcast_param ) 
{
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      /* Setting member variable ( ((struct AltCmd *)(vcast_param)) ) ->newAltitude */
      case 1: { 
        VCAST_TI_8_3 ( &(( ((struct AltCmd *)(vcast_param)) ) ->newAltitude));
        break; /* end case 1*/
      } /* end case */
      /* Setting member variable ( ((struct AltCmd *)(vcast_param)) ) ->crc */
      case 2: { 
        VCAST_TI_8_1 ( &(( ((struct AltCmd *)(vcast_param)) ) ->crc));
        break; /* end case 2*/
      } /* end case */
      default:
        vCAST_TOOL_ERROR = vCAST_true;
...
/* A struct */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_6 ( struct CourseCmd *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_6 */
...
void VCAST_TI_8_6 ( struct CourseCmd *vcast_param ) 
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      /* Setting member variable ( ((struct CourseCmd *)(vcast_param)) ) ->newCourse */
      case 1: { 
        VCAST_TI_8_8 ( &(( ((struct CourseCmd *)(vcast_param)) ) ->newCourse));
        break; /* end case 1*/
      } /* end case */
      /* Setting member variable ( ((struct CourseCmd *)(vcast_param)) ) ->crc */
      case 2: { 
        VCAST_TI_8_1 ( &(( ((struct CourseCmd *)(vcast_param)) ) ->crc));
        break; /* end case 2*/
      } /* end case */
      default:
        vCAST_TOOL_ERROR = vCAST_true;
...
void VCAST_TI_8_8 ( float *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_8 */
...
/* An array */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_9 ( char vcast_param[8] ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_9 */
...
{
  {
    int VCAST_TI_8_9_array_index = 0;
    int VCAST_TI_8_9_index = 0;
    int VCAST_TI_8_9_first, VCAST_TI_8_9_last;
    int VCAST_TI_8_9_local_field = 0;
    int VCAST_TI_8_9_value_printed = 0;
    int VCAST_TI_8_9_is_string = (VCAST_FIND_INDEX()==-1);

    vcast_get_range_value (&VCAST_TI_8_9_first, &VCAST_TI_8_9_last);
    VCAST_TI_8_9_local_field = vCAST_DATA_FIELD;
    {
      int VCAST_TI_8_9_upper = 8;
      for (VCAST_TI_8_9_array_index=0; VCAST_TI_8_9_array_index< VCAST_TI_8_9_upper; VCAST_TI_8_9_array_index++){
        if ( (VCAST_TI_8_9_index >= VCAST_TI_8_9_first) && ( VCAST_TI_8_9_index <= VCAST_TI_8_9_last)){
          if ( VCAST_TI_8_9_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, 1,VCAST_TI_8_9_upper);
          else
            VCAST_TI_8_2 ( &(vcast_param[VCAST_TI_8_9_index]));
          VCAST_TI_8_9_value_printed = 1;
          vCAST_DATA_FIELD = VCAST_TI_8_9_local_field;
        } /* if */
        if (VCAST_TI_8_9_index >= VCAST_TI_8_9_last)
          break;
        VCAST_TI_8_9_index++;
      } /* loop */
      if ((vCAST_COMMAND == vCAST_PRINT)&&(!VCAST_TI_8_9_value_printed))
...
/* An array */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_10 ( int vcast_param[4] ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_10 */
...
{
  {
    int VCAST_TI_8_10_array_index = 0;
    int VCAST_TI_8_10_index = 0;
    int VCAST_TI_8_10_first, VCAST_TI_8_10_last;
    int VCAST_TI_8_10_local_field = 0;
    int VCAST_TI_8_10_value_printed = 0;

    vcast_get_range_value (&VCAST_TI_8_10_first, &VCAST_TI_8_10_last);
    VCAST_TI_8_10_local_field = vCAST_DATA_FIELD;
    {
      int VCAST_TI_8_10_upper = 4;
      for (VCAST_TI_8_10_array_index=0; VCAST_TI_8_10_array_index< VCAST_TI_8_10_upper; VCAST_TI_8_10_array_index++){
        if ( (VCAST_TI_8_10_index >= VCAST_TI_8_10_first) && ( VCAST_TI_8_10_index <= VCAST_TI_8_10_last)){
          VCAST_TI_8_1 ( &(vcast_param[VCAST_TI_8_10_index]));
          VCAST_TI_8_10_value_printed = 1;
          vCAST_DATA_FIELD = VCAST_TI_8_10_local_field;
        } /* if */
        if (VCAST_TI_8_10_index >= VCAST_TI_8_10_last)
          break;
        VCAST_TI_8_10_index++;
      } /* loop */
      if ((vCAST_COMMAND == vCAST_PRINT)&&(!VCAST_TI_8_10_value_printed))
        vectorcast_fprint_string(vCAST_OUTPUT_FILE,"<<past end of array>>\n");
    }
  }
} /* end VCAST_TI_8_10 */
...
/* An integer */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_3 ( unsigned *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_3 */
...
/* An integer */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_8_2 ( char *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_8_2 */
...
#define VCAST_TI_ARRAY_TYPE  "NEW_ARRAY\n"
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, VCAST_TI_SCALAR_TYPE );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"800008\n" );
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
#endif
  /* Range Data for TI (array) VCAST_TI_8_9 */
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"%%\n");
  /* Range Data for TI (array) VCAST_TI_8_10 */
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, VCAST_TI_ARRAY_TYPE );
...
for stub processing and value/expected user code */
#include "USER_GLOBALS_VCAST_uc.cpp"
