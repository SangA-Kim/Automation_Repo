...
enum Boolean rc=(VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,0,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,0),True));
 {
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,1);
{vcast_switch_taken_1 = 0;
switch ( messageCategory )
 {
   case Change_Altitude:VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,1);vcast_switch_taken_1 = 1;
   {
      AltCmdT *cmd = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,2),(AltCmdT *)message);
      int altitude = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,3),cmd->newAltitude);
      if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,(VCAST_CONDITION_TYP)((altitude < 10) || (altitude > 40000))) )
      {
...
break;
   ...
   case Change_Course:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,1);vcast_switch_taken_1 = 1;
   {
      CourseCmdT *cmd = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,9),(CourseCmdT *)message);
      float course = (VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,10),cmd->newCourse);
      if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,(VCAST_CONDITION_TYP)((course < 0) || (course > (2*(3.14159265))))))
      {
...
break;
   ...
   case Text_Message:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,1);vcast_switch_taken_1 = 1;
   {
      char *ascii_msg;
...
break;
   ...
   default:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,6,1);vcast_switch_taken_1 = 1;
