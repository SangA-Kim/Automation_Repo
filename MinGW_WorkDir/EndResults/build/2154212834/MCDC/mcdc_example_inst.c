...
if ( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME(vcast_unit_optimized_mcdc_bytes_9_3, &vcast_mcdc_statement, 9, 0, 3, (VCAST_CONDITION_TYP)((VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(time > 800))
) && (VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 2, (VCAST_CONDITION_TYP)(time < 1700))
) && (VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 3, (VCAST_CONDITION_TYP)(day != SUNDAY))
))))
  {
...
int Conditional_Example (int a, int b, int c) {  struct vcast_mcdc_statement vcast_mcdc_statement = {0, 0};
/*vcast_internal_start*/
extern int P_9_2_1;
extern int P_9_2_2;
extern int P_9_2_3;
...
if ( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME(vcast_unit_optimized_mcdc_bytes_9_3, &vcast_mcdc_statement, 9, 1, 3, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(a))
 && (VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 2, (VCAST_CONDITION_TYP)(b))
 || VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 3, (VCAST_CONDITION_TYP)(c))
))))
      {
