 ...
 * Name: mcdc_example
 *
 * Path: C:/VCAST/Environments/Git_Test/SourceFiles/mcdc_example.c
 *
...
#include "mcdc_example_inst_prefix.c"
#else
#include "mcdc_example_vcast_prefix.c"
#endif
#ifdef VCAST_COVERAGE
/* If coverage is enabled, include the instrumented UUT */
#include "mcdc_example_inst.c"
#else
/* If coverage is not enabled, include the original UUT */
#include "mcdc_example_vcast.c"
#endif
#ifdef VCAST_COVERAGE
#include "mcdc_example_inst_appendix.c"
#else
#include "mcdc_example_vcast_appendix.c"
#endif
#endif /* VCAST_DRIVER_ONLY */
#include "mcdc_example_driver_prefix.c"
#ifdef VCAST_HEADER_EXPANSION
#ifdef VCAST_COVERAGE
#include "mcdc_example_exp_inst_driver.c"
#else
#include "mcdc_example_expanded_driver.c"
...
void VCAST_RUN_DATA_IF_9( int VCAST_SUB_INDEX, int VCAST_PARAM_INDEX ) {
  switch ( VCAST_SUB_INDEX ) {
    ...
    case 1: /* function open_for_business */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
      ...
      break; /* function open_for_business */
    case 2: /* function Conditional_Example */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
      ...
      break; /* function Conditional_Example */
    default:
      vCAST_TOOL_ERROR = vCAST_true;
      break;
  } /* switch ( VCAST_SUB_INDEX ) */
...
void VCAST_TI_9_2 ( enum e_day_of_week *vcast_param ) 
{
...
void VCAST_TI_9_2 ( enum e_day_of_week *vcast_param ) 
{
  ...
  case vCAST_SET_VAL:
    *vcast_param = (enum e_day_of_week ) vCAST_VALUE_INT;
    break;
