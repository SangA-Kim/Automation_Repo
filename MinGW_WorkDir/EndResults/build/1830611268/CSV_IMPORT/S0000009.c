 ...
 * Name: line
 *
 * Path: C:/VCAST/Environments/Git_Test/SourceFiles/line.c
 *
...
#include "line_inst_prefix.c"
#else
#include "line_vcast_prefix.c"
#endif
#ifdef VCAST_COVERAGE
...
#include "line_vcast.c"
#endif
#ifdef VCAST_COVERAGE
#include "line_inst_appendix.c"
#else
#include "line_vcast_appendix.c"
#endif
#endif /* VCAST_DRIVER_ONLY */
#include "line_driver_prefix.c"
#ifdef VCAST_HEADER_EXPANSION
#ifdef VCAST_COVERAGE
#include "line_exp_inst_driver.c"
#else
#include "line_expanded_driver.c"
...
void VCAST_RUN_DATA_IF_9( int VCAST_SUB_INDEX, int VCAST_PARAM_INDEX ) {
  switch ( VCAST_SUB_INDEX ) {
    ...
    case 1: /* function findY */
      ...
      break; /* function findY */
    case 2: /* function findX */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
      ...
      break; /* function findX */
    case 3: /* function findM */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
      ...
      break; /* function findM */
    case 4: /* function findB */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
...
void VCAST_TI_9_2 ( struct coordT *vcast_param ) 
{
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      /* Setting member variable vcast_param->X */
      case 1: { 
        VCAST_TI_8_3 ( &(vcast_param->X));
        break; /* end case 1*/
      } /* end case */
      /* Setting member variable vcast_param->Y */
      case 2: { 
        VCAST_TI_8_3 ( &(vcast_param->Y));
        break; /* end case 2*/
      } /* end case */
      default:
        vCAST_TOOL_ERROR = vCAST_true;
