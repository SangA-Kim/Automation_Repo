...
/*vcast_header_expansion_start:advanced_stubbing_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
extern int vCAST_ITERATION_COUNTERS [3][8];
/***********************************************
 *      VectorCAST Test Harness Component      *
 *     Copyright 2021 Vector Informatik, GmbH.    *
 *              20.sp6 (02/02/21)              *
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:advanced_stubbing_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
