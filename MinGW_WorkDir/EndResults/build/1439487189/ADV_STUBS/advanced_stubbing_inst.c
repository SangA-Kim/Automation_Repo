...
/*vcast_internal_start*/{/*vcast_internal_end*/
  char* ptr = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,0,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,0),(char*)malloc( 10 )));
  if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(!ptr)) )
  {
...
/*vcast_internal_start*/{/*vcast_internal_end*/
    ...
    VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,1);
if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,(VCAST_CONDITION_TYP)(!func_ptr)) )
    {
...
current_temperature = (*func_ptr)();
        if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,(VCAST_CONDITION_TYP)(scale == CELSIUS)))
        {
            if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,(VCAST_CONDITION_TYP)(current_temperature <= 0.0)))
                {
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,6);
rc = FREEZING;}
            else {
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,6,(VCAST_CONDITION_TYP)(current_temperature >= 100.0)))
                {
...
rc = NORMAL;}
        ...
        if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,7,(VCAST_CONDITION_TYP)(scale == FAHRENHEIT)))
        {
            if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,8,(VCAST_CONDITION_TYP)(current_temperature <= 32.0)))
                {
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,9);
rc = FREEZING;}
            else {
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,9,(VCAST_CONDITION_TYP)(current_temperature >= 212.0)))
                {
...
/*vcast_internal_start*/{/*vcast_internal_end*/
    ...
    char str[100];
    {
VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,10,1);
for (i=0;  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,11,(VCAST_CONDITION_TYP)(i < string_length)); i++)
    {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,13);
ch = read_key_pad();
        if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,12,(VCAST_CONDITION_TYP)(!((ch >= '0') && (ch <= '9'))))) {
...
/*vcast_internal_start*/{/*vcast_internal_end*/
    ...
    time_t tod = (VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,13,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,18),time(
                     ((void *)0)
                         )));
    if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,14,(VCAST_CONDITION_TYP)(debug_flag)) )
    {
