...
if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(fp->isOpen)) )
  {
     VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,0);
close_ret = fclose ( (FILE *)fp->fileHandle );
     if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,(VCAST_CONDITION_TYP)(close_ret == 0)))
         {
...
struct FILE_TYPE *retVal;
   VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,1);
...
retVal = (struct FILE_TYPE *)malloc(sizeof(struct FILE_TYPE));
   if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,(VCAST_CONDITION_TYP)(!retVal)))
   {
...
switch ( mode )
   {
   case F_READ:VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,1);vcast_switch_taken_1 = 1;
...
break;
   case F_WRITE:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,6,1);vcast_switch_taken_1 = 1;
...
break;
   case F_APPEND:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,7,1);vcast_switch_taken_1 = 1;
...
break;
   ...
   if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,8,(VCAST_CONDITION_TYP)(retVal->fileHandle == 0)))
   {
...
/*vcast_internal_start*/{/*vcast_internal_end*/
  char *ret_ptr;
  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,9,1);
if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,10,(VCAST_CONDITION_TYP)(fp->isOpen)) )
  {
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,18);
ret_ptr = fgets ( line, 100, (FILE *)fp->fileHandle );
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,11,(VCAST_CONDITION_TYP)(ret_ptr == 0)))
      {
...
/*vcast_internal_start*/{/*vcast_internal_end*/
  int rc;
  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,12,1);
if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,13,(VCAST_CONDITION_TYP)(fp->isOpen)) )
  {
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,22);
rc = fprintf ( (FILE *)fp->fileHandle, "%s", line );
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,14,(VCAST_CONDITION_TYP)(rc == strlen(line))))
      {
...
if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,16,(VCAST_CONDITION_TYP)(fp->isOpen)) )
  {
...
if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,18,(VCAST_CONDITION_TYP)(fp->isOpen)) )
  {
