/*vcast_separate_expansion_start:S0000011.cpp*/
/***********************************************
...
/*vcast_header_expansion_start:shape_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
/*vcast_header_expansion_end*/
/*vcast_header_expansion_start:vcast_stubs_11.c*/
  ...
  try {
    ...
    switch( VC_SUBPROGRAM ) {
      ...
      case 2: {
        ...
        vCAST_USER_CODE_TIMER_START();
        R_11_2 =
        ( (const_cast< const class ::Shape * >(C_3429158504_11))->getX( ) );
        break; }
      case 3: {
        ...
        vCAST_USER_CODE_TIMER_START();
        R_11_3 =
        ( (const_cast< const class ::Shape * >(C_3429158504_11))->getY( ) );
        break; }
      default:
...
/*vcast_header_expansion_start:vcast_ti_decls_11.h*/
extern "C" {
void VCAST_TI_11_3 ( class Shape **vcast_param ) ;
  ...
  switch ( VCAST_SUB_INDEX ) {
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        case 1: /* for global object C_3429158504_11 */
          VCAST_TI_11_3 ( &(C_3429158504_11));
          break;
        default:
    ...
    case 5: /* function Shape::Shape */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          VCAST_TI_8_2 ( &(P_10_8_1));
          break;
        case 2:
          VCAST_TI_8_2 ( &(P_10_8_2));
          break;
        case 3:
          VCAST_TI_SBF_OBJECT( &SBF_10_8 );
          break;
      } /* switch ( VCAST_PARAM_INDEX ) */
      break; /* function Shape::Shape */
    case 1: /* function Shape::setPosition */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          VCAST_TI_8_2 ( &(P_11_1_1));
          break;
        case 2:
          VCAST_TI_8_2 ( &(P_11_1_2));
          break;
        case 3:
...
struct VCAST_CSU_Data *vcast_csu_data_11 = (struct VCAST_CSU_Data *)0;
/* A pointer */
void VCAST_TI_11_3 ( class Shape **vcast_param )
{
  {
                ...
                switch ( vcast_get_param() ) {
                  case 1: {
                    if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                      ...
                      vcast_item1 = VCAST_Get_CSU_Data ( &vcast_csu_data_11, vCAST_PARAMETER_KEY);
                      if (vcast_item1 == 0) {
                      ...
                      if ((vCAST_COMMAND == vCAST_SET_VAL) || (vCAST_COMMAND == vCAST_ALLOCATE)) {
                        if (!vcast_found)
                          VCAST_Add_CSU_Data (&vcast_csu_data_11, vcast_item1);
                      }
                  ...
                  case 2: {
                    if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                      ...
                      /* If the value exists, it was already allocated. Look it up. */
                      vCAST_boolean vcast_found = vCAST_true;
                      vcast_item2 = VCAST_Get_CSU_Data ( &vcast_csu_data_11, vCAST_PARAMETER_KEY);
                      if (vcast_item2 == 0) {
                        vcast_found = vCAST_false;
                      ...
                      if ((vCAST_COMMAND == vCAST_SET_VAL) || (vCAST_COMMAND == vCAST_ALLOCATE)) {
                        if (!vcast_found)
                          VCAST_Add_CSU_Data (&vcast_csu_data_11, vcast_item2);
                      }
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:shape_uc.cpp*/
void vCAST_VALUE_USER_CODE_11(int vcast_slot_index ) {
  {
