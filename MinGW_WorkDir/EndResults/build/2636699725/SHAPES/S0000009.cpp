...
#include "rectangle_inst_prefix.c"
#else
#include "rectangle_vcast_prefix.c"
#endif
#ifdef VCAST_COVERAGE
/* If coverage is enabled, include the instrumented UUT */
#include "rectangle_inst.cpp"
#else
/* If coverage is not enabled, include the original UUT */
#include "rectangle_vcast.cpp"
#endif
#ifdef VCAST_COVERAGE
#include "rectangle_inst_appendix.c"
#else
#include "rectangle_vcast_appendix.c"
#endif
#endif /* VCAST_DRIVER_ONLY */
#include "rectangle_driver_prefix.c"
#ifdef VCAST_HEADER_EXPANSION
#ifdef VCAST_COVERAGE
#include "rectangle_exp_inst_driver.c"
#else
#include "rectangle_expanded_driver.c"
