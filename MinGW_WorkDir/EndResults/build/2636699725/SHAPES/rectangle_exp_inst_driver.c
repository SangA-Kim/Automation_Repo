 ...
 * Name: rectangle
 *
 * Path: C:/VCAST/Environments/Git_Test/SourceFiles/Shapes/rectangle.cpp
 *
...
/*vcast_header_expansion_start:rectangle_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
extern int vCAST_ITERATION_COUNTERS [4][15];
/***********************************************
 *      VectorCAST Test Harness Component      *
 *     Copyright 2021 Vector Informatik, GmbH.    *
 *              20.sp6 (02/02/21)              *
...
void VCAST_DRIVER_11( int VC_SUBPROGRAM );void VCAST_SBF_11( int VC_SUBPROGRAM );
/*vcast_header_expansion_end*/
...
class Rectangle;
extern class Rectangle *C_3328162424_9;
class Shape;
extern class Shape *C_3429158504_11;
/*vcast_header_expansion_end*/
class Rectangle *C_3328162424_9;
/* Begin Function Rectangle::setPosition */
int P_9_4_1;
int P_9_4_2;
/* Begin Function Rectangle::getX */
int R_9_5;
/* Begin Function Rectangle::getY */
int R_9_6;
extern class Rectangle *C_3328162424_9;
;
/*vcast_header_expansion_start:vcast_concrete_classes.cpp*/
...
: Shape(x ,y) {
  ...
  if ( vcast_is_in_driver ) {
    P_10_4_1 = x;
    P_10_4_2 = y;
    vCAST_COMMON_STUB_PROC_9( 10, 4, 3, 0 );
  } /* vcast_is_in_driver */
  vCAST_USER_CODE_TIMER_START();
  return;
}
...
std::__cxx11::string R_10_5;
std::__cxx11::string Shape::getName() const
{
  vCAST_USER_CODE_TIMER_STOP();
  if ( vcast_is_in_driver ) {
  ...
  try {
    ...
    switch( VC_SUBPROGRAM ) {
      ...
      case 5: {
        ...
        vCAST_USER_CODE_TIMER_START();
        R_9_5 =
        ( (const_cast< const class ::Rectangle * >(C_3328162424_9))->getX( ) );
        break; }
      case 6: {
        ...
        vCAST_USER_CODE_TIMER_START();
        R_9_6 =
        ( (const_cast< const class ::Rectangle * >(C_3328162424_9))->getY( ) );
        break; }
      case 7: {
        /* std::__cxx11::string Rectangle::getName() const */
        if (C_3328162424_9 == (0)){
          vCAST_APPEND_HISTORY_FLAG('N');
        }
        ...
        vCAST_USER_CODE_TIMER_START();
        R_9_7 =
        ( (const_cast< const class ::Rectangle * >(C_3328162424_9))->getName( ) );
        break; }
      case 1: {
        /* Rectangle::Rectangle() */
      ...
      case 3: {
        ...
        vCAST_USER_CODE_TIMER_START();
        R_9_3 =
        ( (const_cast< const class ::Rectangle * >(C_3328162424_9))->getArea( ) );
        break; }
      default:
...
void VCAST_TI_9_14 ( class Rectangle **vcast_param ) ;
}
/*vcast_header_expansion_end*/
void VCAST_RUN_DATA_IF_9( int VCAST_SUB_INDEX, int VCAST_PARAM_INDEX ) {
  switch ( VCAST_SUB_INDEX ) {
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        case 1: /* for global object C_3328162424_9 */
          VCAST_TI_9_14 ( &(C_3328162424_9));
          break;
        default:
    ...
    case 9: /* function vcast_concrete_Shape::getArea */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          VCAST_TI_8_3 ( &(R_10_2));
          break;
    ...
    case 8: /* function vcast_concrete_Shape::getName */
      switch ( VCAST_PARAM_INDEX ) {
      case 1:
        VCAST_TI_9_7 ( &R_10_1);
        break;
  ...
  case 11: /* function vcast_concrete_Shape::vcast_concrete_Shape */
    switch ( VCAST_PARAM_INDEX ) {
      case 1:
        VCAST_TI_8_2 ( &(P_10_4_1));
        break;
      case 2:
        VCAST_TI_8_2 ( &(P_10_4_2));
        break;
    } /* switch ( VCAST_PARAM_INDEX ) */
    break; /* function vcast_concrete_Shape::vcast_concrete_Shape */
  case 4: /* function Rectangle::setPosition */
    switch ( VCAST_PARAM_INDEX ) {
      case 1:
        VCAST_TI_8_2 ( &(P_9_4_1));
        break;
      case 2:
        VCAST_TI_8_2 ( &(P_9_4_2));
        break;
    } /* switch ( VCAST_PARAM_INDEX ) */
    break; /* function Rectangle::setPosition */
  case 5: /* function Rectangle::getX */
    switch ( VCAST_PARAM_INDEX ) {
      case 1:
        VCAST_TI_8_2 ( &(R_9_5));
        break;
    } /* switch ( VCAST_PARAM_INDEX ) */
    break; /* function Rectangle::getX */
  case 6: /* function Rectangle::getY */
    switch ( VCAST_PARAM_INDEX ) {
      case 1:
        VCAST_TI_8_2 ( &(R_9_6));
        break;
    } /* switch ( VCAST_PARAM_INDEX ) */
    break; /* function Rectangle::getY */
  case 12: /* function Shape::getName */
    switch ( VCAST_PARAM_INDEX ) {
    case 1:
      VCAST_TI_9_7 ( &R_10_5);
      break;
...
case 13: /* function Shape::getArea */
  switch ( VCAST_PARAM_INDEX ) {
    case 1:
      VCAST_TI_8_3 ( &(R_10_6));
      break;
...
case 7: /* function Rectangle::getName */
  switch ( VCAST_PARAM_INDEX ) {
  case 1:
    VCAST_TI_9_7 ( &R_9_7);
    break;
...
break; /* function Rectangle::getName */
case 1: /* function Rectangle::Rectangle */
  switch ( VCAST_PARAM_INDEX ) {
    case 1:
...
case 2: /* function Rectangle::Rectangle */
  switch ( VCAST_PARAM_INDEX ) {
    case 1:
      VCAST_TI_8_2 ( &(P_9_2_1));
      break;
    case 2:
      VCAST_TI_8_2 ( &(P_9_2_2));
      break;
    case 3:
      VCAST_TI_8_2 ( &(P_9_2_3));
      break;
    case 4:
      VCAST_TI_8_2 ( &(P_9_2_4));
      break;
    case 5:
  ...
  break; /* function Rectangle::Rectangle */
case 3: /* function Rectangle::getArea */
  switch ( VCAST_PARAM_INDEX ) {
    case 1:
      VCAST_TI_8_3 ( &(R_9_3));
      break;
                  ...
                  case 2: {
                    if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                      ...
                      if (vcast_item2 == 0) {
                        ...
                        memset(vcast_item2->vcast_item, 0x0, sizeof ((*((int *)(vcast_item2->vcast_item)))));
                        vcast_item2->vcast_next = (struct VCAST_CSU_Data_Item *)0;
                        vcast_item2->vcast_command = (char*)VCAST_malloc (sizeof(char)*(strlen (vCAST_PARAMETER_KEY)+1));
                        strcpy (vcast_item2->vcast_command, vCAST_PARAMETER_KEY);
                      }
                      if ((vCAST_COMMAND == vCAST_SET_VAL) || (vCAST_COMMAND == vCAST_ALLOCATE)) {
                        if (!vcast_found)
                  ...
                  case 3: {
                    if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                      ...
                      if (vcast_item3 == 0) {
                        ...
                        memset(vcast_item3->vcast_item, 0x0, sizeof ((*((int *)(vcast_item3->vcast_item)))));
                        vcast_item3->vcast_next = (struct VCAST_CSU_Data_Item *)0;
                        vcast_item3->vcast_command = (char*)VCAST_malloc (sizeof(char)*(strlen (vCAST_PARAMETER_KEY)+1));
                        strcpy (vcast_item3->vcast_command, vCAST_PARAMETER_KEY);
                      }
                      if ((vCAST_COMMAND == vCAST_SET_VAL) || (vCAST_COMMAND == vCAST_ALLOCATE)) {
                        if (!vcast_found)
                  ...
                  case 4: {
                    if ((vCAST_COMMAND == vCAST_PRINT) &&(vCAST_can_print_constructor == vCAST_false)) {
                      ...
                      if (vcast_item4 == 0) {
                        ...
                        memset(vcast_item4->vcast_item, 0x0, sizeof ((*((int *)(vcast_item4->vcast_item)))));
                        vcast_item4->vcast_next = (struct VCAST_CSU_Data_Item *)0;
                        vcast_item4->vcast_command = (char*)VCAST_malloc (sizeof(char)*(strlen (vCAST_PARAMETER_KEY)+1));
                        strcpy (vcast_item4->vcast_command, vCAST_PARAMETER_KEY);
                      }
                      if ((vCAST_COMMAND == vCAST_SET_VAL) || (vCAST_COMMAND == vCAST_ALLOCATE)) {
                        if (!vcast_found)
                  ...
                  case 999: {
                    if (vCAST_COMMAND == vCAST_PRINT) {
                      ...
                      *vcast_param = vcast_class_pointer;
                      ...
                      if (was_allocated_2) {
                        free (vcast_item2->vcast_item);
                        free (vcast_item2);
                      }
                      if (was_allocated_3) {
                        free (vcast_item3->vcast_item);
                        free (vcast_item3);
                      }
                      if (was_allocated_4) {
                        free (vcast_item4->vcast_item);
                        free (vcast_item4);
                      }
                    } /* end if */
                    break;
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:rectangle_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
