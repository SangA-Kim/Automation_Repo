...
#endif
#define VCAST_COVERAGE_TYPE_STATEMENT_BRANCH
 ...
 *   statement bit array:.................size: 1          count: 2      bytes:  2
 *   branch bit array:....................size: 1          count: 3      bytes:  3
 *   Total (no MC/DC pool storage):......................................bytes:  5 *
 * 
...
#endif
#ifdef VCAST_COVER_NO_INIT
char vcast_unit_branch_bytes_9[1];
#else
char vcast_unit_branch_bytes_9[1] = { 0 };
#endif
#ifdef VCAST_COVER_NO_INIT
char vcast_unit_stmt_bytes_11[1];
#else
char vcast_unit_stmt_bytes_11[1] = { 0 };
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_branch_bytes_11[2] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_branch_bytes_11[2];
#else
char vcast_unit_branch_bytes_11[2] = 
  {0,0};
#endif
...
static const struct vcast_unit_list vcast_unit_list_values[] = {
  {9, (char *)vcast_unit_stmt_bytes_9, sizeof(vcast_unit_stmt_bytes_9), (char *)vcast_unit_branch_bytes_9, sizeof(vcast_unit_branch_bytes_9)},
  {11, (char *)vcast_unit_stmt_bytes_11, sizeof(vcast_unit_stmt_bytes_11), (char *)vcast_unit_branch_bytes_11, sizeof(vcast_unit_branch_bytes_11)},
  {0, 0, 0, 0, 0}
};
