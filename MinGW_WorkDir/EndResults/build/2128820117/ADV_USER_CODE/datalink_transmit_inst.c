...
/*vcast_internal_end*/
/*vcast_internal_start*/{/*vcast_internal_end*/
    int timeout_ctr=(VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,0,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,0),0));
    int i=(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,1),0);
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(!msg)))
    {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,2);
return(BAD_PTR);
    }
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,(VCAST_CONDITION_TYP)((msg_len < 1) || (msg_len > 100))))
    {
...
*/
    {
while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,(VCAST_CONDITION_TYP)(i < msg_len)))
    {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,4);
*((unsigned char *)0x8000000) = 1;
        if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,(VCAST_CONDITION_TYP)(*((unsigned char *)0x8000000) & 1)))
        {
...
((unsigned char *)0x8000004)[i++] = *msg++;
        ...
        {
            if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,(VCAST_CONDITION_TYP)(++timeout_ctr > 10)))
            {
...
/*vcast_internal_end*/
/*vcast_internal_start*/{/*vcast_internal_end*/
    int timeout_ctr=(VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,6,1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,11),0));
    int i=(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,12),0);
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,7,(VCAST_CONDITION_TYP)(!data_ptr)))
    {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,13);
return(BAD_PTR);
    }
    {
while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,8,(VCAST_CONDITION_TYP)(i < data_len)))
    {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,14);
hw_send_rts();
        if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,9,(VCAST_CONDITION_TYP)(hw_check_cts())))
        {
...
i++;
        ...
        {
            if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,10,(VCAST_CONDITION_TYP)(++timeout_ctr > 10)))
            {
...
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,12,(VCAST_CONDITION_TYP)(!msg)))
    {
        VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_9,9,22);
return(BAD_PTR);
    }
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,13,(VCAST_CONDITION_TYP)((msg_len < 1) || (msg_len > 100))))
    {
...
rc = data_tx_V2( (unsigned char *)&pkt, sizeof(t_msg_hdr) + msg_len );
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,14,(VCAST_CONDITION_TYP)(log_flag)))
    {
