 ...
 *
 * Path: C:/VCAST/Environments/Git_Test/MinGW_WorkDir/EndResults/build/2128820117/ADV_USER_CODE/S0000008.cpp
 *
 * Type: not-stubbed
 *
 * Unit Number: 8
    ...
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        ...
        case 2: /* for global object VECTORCAST_INT2 */
          ...
          break;
        case 3: /* for global object my_stub_ctr */
          VCAST_TI_8_2 ( &(my_stub_ctr));
          break;
...
{
  {
    ...
    vcast_get_range_value (&VCAST_TI_8_4_first, &VCAST_TI_8_4_last);
      ...
      for (VCAST_TI_8_4_array_index=0; VCAST_TI_8_4_array_index< VCAST_TI_8_4_upper; VCAST_TI_8_4_array_index++){
        if ( (VCAST_TI_8_4_index >= VCAST_TI_8_4_first) && ( VCAST_TI_8_4_index <= VCAST_TI_8_4_last)){
          if ( VCAST_TI_8_4_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, 1,VCAST_TI_8_4_upper);
          else
