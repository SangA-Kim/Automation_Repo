...
/*vcast_header_expansion_start:datalink_transmit_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
extern int vCAST_ITERATION_COUNTERS [3][13];
/***********************************************
 *      VectorCAST Test Harness Component      *
 *     Copyright 2021 Vector Informatik, GmbH.    *
 *              20.sp6 (02/02/21)              *
      ...
      if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
        ...
        if (VCAST_FIND_INDEX() == -1) {
          ...
          *VCAST_TI_9_3_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_3_array_size*(sizeof(unsigned char )));
          memset((void*)*vcast_param, 0x0, VCAST_TI_9_3_array_size*(sizeof(unsigned char )));
          ;
        }
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:datalink_transmit_uc.cpp*/
/********************/
