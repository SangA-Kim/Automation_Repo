...
/*vcast_header_expansion_start:vcast_time_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
void VCAST_TI_9_2 ( struct time *vcast_param ) ;
/*vcast_header_expansion_end*/
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      /* Setting member variable vcast_param->mins */
      case 1: {
        VCAST_TI_8_2 ( &(vcast_param->mins));
        break; /* end case 1*/
      } /* end case */
      /* Setting member variable vcast_param->secs */
      case 2: {
        VCAST_TI_8_2 ( &(vcast_param->secs));
        break; /* end case 2*/
      } /* end case */
      default:
        vCAST_TOOL_ERROR = vCAST_true;
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:vcast_time_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
