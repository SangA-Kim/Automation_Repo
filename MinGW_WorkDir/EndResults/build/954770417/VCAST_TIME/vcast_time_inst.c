...
#endif
/*vcast_header_expansion_start:C:\\VCAST\\TRAINING\\SOURCEFILES\\SEARCHPATHS\\include/vcast_time.h*/
typedef struct time {
    int mins ;
    int secs ;
} time_T ;
...
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(invalid_time(start))))
    {
...
ret.mins = start.mins ;
    if (  VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,(VCAST_CONDITION_TYP)(newseconds >= 60)) )
    {
