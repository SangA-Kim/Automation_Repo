...
/*vcast_header_expansion_start:probe_points_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
extern int vCAST_ITERATION_COUNTERS [3][10];
/***********************************************
 *      VectorCAST Test Harness Component      *
 *     Copyright 2021 Vector Informatik, GmbH.    *
 *              20.sp6 (02/02/21)              *
...
int P_10_1_1;
void door_ajar_alarm(int VCAST_PARAM_1)
{
...
char *P_10_3_1;
void report_error(char * VCAST_PARAM_1)
{
  vCAST_USER_CODE_TIMER_STOP();
  if ( vcast_is_in_driver ) {
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:probe_points_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
