 ...
 *   statement bit array:.................size: 1          count: 4      bytes:  4
 *   branch bit array:....................size: 1          count: 4      bytes:  4
 *   Total (no MC/DC pool storage):......................................bytes:  8 *
 * 
...
char vcast_unit_stmt_bytes_9[4] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_stmt_bytes_9[4];
#else
char vcast_unit_stmt_bytes_9[4] = 
  {0,0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_branch_bytes_9[4] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_branch_bytes_9[4];
#else
char vcast_unit_branch_bytes_9[4] = 
  {0,0,0,0};
#endif
