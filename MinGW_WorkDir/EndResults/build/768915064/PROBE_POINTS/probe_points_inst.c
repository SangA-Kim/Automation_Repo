...
switch (current_state)
    {
        case POWER_UP:VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,1);vcast_switch_taken_1 = 1;
...
break;
        case DOOR_OPEN:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,1);vcast_switch_taken_1 = 1;
...
break;
        case DOOR_CLOSED:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,1);vcast_switch_taken_1 = 1;
...
break;
    ...
    if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,(VCAST_CONDITION_TYP)(open_count == 3)))
    {
...
close_count=3;
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,5,(VCAST_CONDITION_TYP)(close_count == 3)))
    {
...
if (vcast_test_name_equals( "TruePath" ))
  ...
  reg_value=0;
  if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,7,(VCAST_CONDITION_TYP)(reg_value & 0x04)))
    {
...
while ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,9,(VCAST_CONDITION_TYP)(1)))
    {
        if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,10,(VCAST_CONDITION_TYP)(check_rx_err_bit())))
        {
...
vcast_probe_print( "\n" );
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,12,(VCAST_CONDITION_TYP)(fuel_level > tank_size)))
    {
