 ...
 * Name: cba_example
 *
 * Path: C:/VCAST/Environments/Git_Test/SourceFiles/cba_example.c
 *
...
#include "cba_example_inst_prefix.c"
#else
#include "cba_example_vcast_prefix.c"
#endif
#ifdef VCAST_COVERAGE
/* If coverage is enabled, include the instrumented UUT */
#include "cba_example_inst.c"
#else
/* If coverage is not enabled, include the original UUT */
#include "cba_example_vcast.c"
#endif
#ifdef VCAST_COVERAGE
#include "cba_example_inst_appendix.c"
#else
#include "cba_example_vcast_appendix.c"
#endif
#endif /* VCAST_DRIVER_ONLY */
#include "cba_example_driver_prefix.c"
#ifdef VCAST_HEADER_EXPANSION
#ifdef VCAST_COVERAGE
#include "cba_example_exp_inst_driver.c"
#else
#include "cba_example_expanded_driver.c"
...
void VCAST_RUN_DATA_IF_9( int VCAST_SUB_INDEX, int VCAST_PARAM_INDEX ) {
  switch ( VCAST_SUB_INDEX ) {
    ...
    case 2: /* function send_can_msg */
      ...
      break; /* function send_can_msg */
    case 3: /* function send_enet_msg */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          if( vCAST_COMMAND == vCAST_SET_VAL )
      ...
      break; /* function send_enet_msg */
    case 4: /* function send_serial_msg */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          if( vCAST_COMMAND == vCAST_SET_VAL )
            VCAST_SET_GLOBAL_SIZE( &P_10_3_1_memsize );
      ...
      break; /* function send_serial_msg */
    case 1: /* function route_msg */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
...
/* An enumeration */
#if (defined(VCAST_NO_TYPE_SUPPORT))
void VCAST_TI_9_3 ( enum e_msg_type *vcast_param ) 
{
  /* User code: type is not supported */
  vcast_not_supported();
} /* end VCAST_TI_9_3 */
...
void VCAST_TI_9_3 ( enum e_msg_type *vcast_param ) 
{
  ...
  case vCAST_SET_VAL:
    *vcast_param = (enum e_msg_type ) vCAST_VALUE_INT;
    break;
