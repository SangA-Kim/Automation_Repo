...
if ( VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,1,(VCAST_CONDITION_TYP)(msg_type >= INVALID)))
    {
...
switch (msg_type)
    {
    case CAN_BUS:VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,2,1);vcast_switch_taken_1 = 1;
...
break;
    case ENET:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,3,1);vcast_switch_taken_1 = 1;
...
break;
    case SERIAL:if (!vcast_switch_taken_1) VCAST_BRANCH_INSTRUMENTATION_POINT_REALTIME(vcast_unit_branch_bytes_9,9,4,1);vcast_switch_taken_1 = 1;
