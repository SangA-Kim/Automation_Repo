...
/*vcast_header_expansion_start:cba_example_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
{
  {
    ...
    if (( vCAST_COMMAND == vCAST_PRINT ) && (*vcast_param == 
                                                            ((void *)0)
                                                                )) {
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:cba_example_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
