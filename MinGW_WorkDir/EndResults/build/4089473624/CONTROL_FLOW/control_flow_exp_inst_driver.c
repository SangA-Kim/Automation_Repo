...
/*vcast_header_expansion_start:control_flow_driver_prefix.c*/
/*vcast_header_expansion_end*/
...
enum e_shape P_10_1_1;
float P_10_1_2;
float P_10_1_3;
float P_10_1_4;
int R_10_1;
int validShape(enum e_shape shape, float x, float y, float z)
{
  ...
  if ( vcast_is_in_driver ) {
    ...
    P_10_1_3 = y;
    P_10_1_4 = z;
    vCAST_COMMON_STUB_PROC_9( 10, 1, 5, 0 );
  } /* vcast_is_in_driver */
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:control_flow_uc.cpp*/
void vCAST_VALUE_USER_CODE_9(int vcast_slot_index ) {
  {
