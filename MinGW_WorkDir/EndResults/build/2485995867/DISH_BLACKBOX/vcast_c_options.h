 ...
 *   statement bit array:.................size: 1          count: 8      bytes:  8
 *   branch bit array:....................size: 1          count: 8      bytes:  8
 *   Total (no MC/DC pool storage):......................................bytes:  16 *
 * 
...
char vcast_unit_stmt_bytes_9[8] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_stmt_bytes_9[8];
#else
char vcast_unit_stmt_bytes_9[8] = 
  {0,0,0,0,0,0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_branch_bytes_9[8] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_branch_bytes_9[8];
#else
char vcast_unit_branch_bytes_9[8] = 
  {0,0,0,0,0,0,0,0};
#endif
