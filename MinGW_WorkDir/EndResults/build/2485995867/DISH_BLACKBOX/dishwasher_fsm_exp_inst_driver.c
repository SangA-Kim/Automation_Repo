 ...
 * Name: dishwasher_fsm
 *
 * Path: C:/VCAST/Environments/Git_Test/SourceFiles/dishwasher_fsm.c
 *
...
void VCAST_TI_9_1 ( enum eventValues *vcast_param ) ;
void VCAST_TI_9_2 ( enum e_status *vcast_param ) ;
/*vcast_header_expansion_end*/
