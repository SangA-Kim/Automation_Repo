...
char vcast_unit_stmt_bytes_9[7] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_stmt_bytes_9[7];
#else
char vcast_unit_stmt_bytes_9[7] = 
  {0,0,0,0,0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_9_0[4] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_9_0[4];
#else
char vcast_unit_optimized_mcdc_bytes_9_0[4] = 
  {0,0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_9_1[3] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_9_1[3];
#else
char vcast_unit_optimized_mcdc_bytes_9_1[3] = 
  {0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_9_2[2] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_9_2[2];
#else
char vcast_unit_optimized_mcdc_bytes_9_2[2] = 
  {0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_9_3[8] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_9_3[8];
#else
char vcast_unit_optimized_mcdc_bytes_9_3[8] = 
  {0,0,0,0,0,0,0,0};
#endif
