 ...
 * Name: manager
 *
 * Path: C:/VCAST/Environments/Git_Test/SourceFiles/manager.c
 *
 ...
 *   Total (no MC/DC pool storage):......................................bytes:  29 *
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  16029 *
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  32029 *
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  44029 *
...
void VCAST_TI_9_11 ( struct order_type *vcast_param ) ;
void VCAST_TI_9_12 ( struct table_data_type *vcast_param ) ;
void VCAST_TI_9_13 ( enum boolean *vcast_param ) ;
void VCAST_TI_9_14 ( struct order_type vcast_param[4] ) ;
void VCAST_TI_9_15 ( char vcast_param[10][32] ) ;
void VCAST_TI_9_16 ( enum soups *vcast_param ) ;
...
void VCAST_TI_9_6 ( struct order_type **vcast_param ) ;
void VCAST_TI_9_7 ( enum entrees *vcast_param ) ;
void VCAST_TI_9_8 ( enum salads *vcast_param ) ;
void VCAST_TI_9_9 ( enum beverages *vcast_param ) ;
/*vcast_header_expansion_end*/
    ...
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        ...
        case 2: /* for global object WaitingListSize */
          VCAST_TI_9_4 ( &(WaitingListSize));
          break;
        case 3: /* for global object WaitingListIndex */
          VCAST_TI_9_4 ( &(WaitingListIndex));
          break;
        case 5: /* for global object log_err_cnt */
          VCAST_TI_8_2 ( &(log_err_cnt));
          break;
        case 6: /* for global object state_tax */
          VCAST_TI_8_3 ( &(state_tax));
          break;
        case 7: /* for global object default_tax */
          VCAST_TI_8_3 ( &(default_tax));
          break;
        default:
    ...
    case 11: /* function Update_Table_Record */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          ...
          break;
        case 2:
          VCAST_TI_8_3 ( &(P_10_3_2));
          break;
        case 3:
          VCAST_TI_9_12 ( &(P_10_3_3));
          break;
      } /* switch ( VCAST_PARAM_INDEX ) */
...
{
  {
    ...
    vcast_get_range_value (&VCAST_TI_9_15_first, &VCAST_TI_9_15_last);
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      ...
      case 1: {
        VCAST_TI_9_13 ( &(vcast_param->Is_Occupied));
        break; /* end case 1*/
      } /* end case */
...
{
  {
    ...
    if (((*vcast_param) == 0) && (vCAST_COMMAND != vCAST_ALLOCATE)){
      ...
      if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
        int VCAST_TI_9_6_array_size = (int) vCAST_VALUE;
        if (VCAST_FIND_INDEX() == -1) {
          void **VCAST_TI_9_6_memory_ptr = (void**)vcast_param;
          *VCAST_TI_9_6_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_6_array_size*(sizeof(struct order_type )));
          memset((void*)*vcast_param, 0x0, VCAST_TI_9_6_array_size*(sizeof(struct order_type )));
          ;
        }
        ...
        VCAST_TI_9_6_index = vcast_get_param();
        VCAST_TI_9_11 ( &((*vcast_param)[VCAST_TI_9_6_index]));
      }
    }
  }
} /* end VCAST_TI_9_6 */
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      ...
      case 1: {
        VCAST_TI_9_16 ( &(vcast_param->Soup));
        break; /* end case 1*/
      } /* end case */
      ...
      case 3: {
        VCAST_TI_9_7 ( &(vcast_param->Entree));
        break; /* end case 3*/
      } /* end case */
      ...
      case 5: {
        VCAST_TI_9_9 ( &(vcast_param->Beverage));
        break; /* end case 5*/
      } /* end case */
      default:
        vCAST_TOOL_ERROR = vCAST_true;
      ...
      if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
        ...
        if (VCAST_FIND_INDEX() == -1) {
          ...
          *VCAST_TI_9_2_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_2_array_size*(sizeof(char )));
          memset((void*)*vcast_param, 0x0, VCAST_TI_9_2_array_size*(sizeof(char )));
          ;
        }
      } else if (vCAST_VALUE_NUL == vCAST_true && vcast_proc_handles_command(1)) {
        if (VCAST_FIND_INDEX() == -1)
...
{
  {
    ...
    vcast_get_range_value (&VCAST_TI_9_19_first, &VCAST_TI_9_19_last);
      ...
      for (VCAST_TI_9_19_array_index=0; VCAST_TI_9_19_array_index< VCAST_TI_9_19_upper; VCAST_TI_9_19_array_index++){
        if ( (VCAST_TI_9_19_index >= VCAST_TI_9_19_first) && ( VCAST_TI_9_19_index <= VCAST_TI_9_19_last)){
          if ( VCAST_TI_9_19_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, 1,VCAST_TI_9_19_upper);
          else
...
{
  {
    ...
    vcast_get_range_value (&VCAST_TI_9_18_first, &VCAST_TI_9_18_last);
      ...
      for (VCAST_TI_9_18_array_index=0; VCAST_TI_9_18_array_index< VCAST_TI_9_18_upper; VCAST_TI_9_18_array_index++){
        if ( (VCAST_TI_9_18_index >= VCAST_TI_9_18_first) && ( VCAST_TI_9_18_index <= VCAST_TI_9_18_last)){
          if ( VCAST_TI_9_18_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, 1,VCAST_TI_9_18_upper);
          else
    ...
    VCAST_TI_9_14_local_field = vCAST_DATA_FIELD;
    {
      ...
      for (VCAST_TI_9_14_array_index=0; VCAST_TI_9_14_array_index< VCAST_TI_9_14_upper; VCAST_TI_9_14_array_index++){
        if ( (VCAST_TI_9_14_index >= VCAST_TI_9_14_first) && ( VCAST_TI_9_14_index <= VCAST_TI_9_14_last)){
          VCAST_TI_9_11 ( &(vcast_param[VCAST_TI_9_14_index]));
...
for stub processing and value/expected user code */
/*vcast_header_expansion_start:manager_uc.cpp*/
/********************/
